...
const Home: NextPage = () => {
  return (
    <>
      ...
      >
        <Text>
          Welcome to the latest Experimental Fizzy Tracker
          <br />
          The data here is stored your web browser, but you can login to Google
          to also save it in your Google Drive.
          <br />
